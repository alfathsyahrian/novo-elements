    ...
    template: `
        <div class="novo-fieldset-container">
            ...
            <div *ngFor="let control of controls" class="novo-form-row" [class.disabled]="control.disabled">
                <novo-control *ngIf="control.controlType !== 'custom'" [control]="control" [form]="form"></novo-control>
                <novo-control-custom *ngIf="control.controlType === 'custom'" [control]="control" [form]="form"></novo-control-custom>
            </div>
        </div>
    `
})
